...
import { deleteEmployeeApi, getEmployeesManagerApi } from '../../services/employeeApi';
...
const EmployeeManagerPage = () => {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                const response = await getEmployeesManagerApi();
                console.log(response);

                if (Array.isArray(response.employees)) {
                    setUsers(response.employees);
                    setFilteredData(response.employees);
                    setPagination(prev => ({
                        ...prev,
                        total: response.employees.length,
                    }));
                } else {
