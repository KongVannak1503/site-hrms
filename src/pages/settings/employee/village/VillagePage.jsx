...
import { deleteVillageApi, getVillagesApi } from '../../../../services/villageApi';
import VillageCreatePage from './VillageCreatePage';
import VillageUpdatePage from './VillageUpdatePage';
...
const VillagePage = () => {
    ...
    const handleDelete = async (id) => {
        try {
            await deleteVillageApi(id); // call the API
    ...
    return (
        <div>
            ...
            >
                ...
                >
                    {actionForm === 'create' ? (
                        <VillageCreatePage form={form} onUserCreated={handleAddCreated} onCancel={closeDrawer} />
                    ) : (
                        <VillageUpdatePage onUserUpdated={handleUpdate} dataId={selectedUserId} onCancel={closeDrawer} />
                    )}
                </ModalMdCenter>
