...
import { createCommuneApi } from '../../../../services/communeApi';

const CommuneCreatePage = ({ form, onCancel, onUserCreated }) => {
    ...
    const handleFinish = async (values) => {
        try {
            ...
            const response = await createCommuneApi(formData);
...
export default CommuneCreatePage;
