...
import { deleteCommuneApi, getCommunesApi } from '../../../../services/communeApi';
import CommuneCreatePage from './CommuneCreatePage';
import CommuneUpdatePage from './CommuneUpdatePage';
...
const CommunePage = () => {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                const response = await getCommunesApi();
    ...
    const handleDelete = async (id) => {
        try {
            await deleteCommuneApi(id); // call the API
    ...
    return (
        <div>
            ...
            >
                ...
                >
                    {actionForm === 'create' ? (
                        <CommuneCreatePage form={form} onUserCreated={handleAddCreated} onCancel={closeDrawer} />
                    ) : (
                        <CommuneUpdatePage onUserUpdated={handleUpdate} dataId={selectedUserId} onCancel={closeDrawer} />
                    )}
                </ModalMdCenter>
