...
import { getPositionApi, updatePositionApi } from '../../../apis/positionApi';
import { Typography } from 'antd';

const PositionUpdatePage = ({ dataId, onCancel, onUserUpdated }) => {
    ...
    useEffect(() => {
        const fetchInitialData = async () => {
            const response = await getPositionApi(dataId);
            form.setFieldsValue({
