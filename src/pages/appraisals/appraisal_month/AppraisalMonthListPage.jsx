...
import { getAllDayKpiApi } from '../../../services/KpiApi';

const AppraisalMonthListPage = () => {
    const { id } = useParams();
    ...
    const breadcrumbItems = [
        ...
        { breadcrumbName: content['appraisalDay'], path: '/appraisal/month' },
                ...
                <Space size="middle" style={{ display: "flex", justifyContent: "center" }}>
                    ...
                    <Tooltip title={content['edit']}>
                        <button
                            ...
                            shape="circle"
                            onClick={() => handleUpdate(id, record._id)}
                        >
                            <FormOutlined />
                        </button>
                    </Tooltip>
    ...
    const handleUpdate = (empId, id) => {
        navigate(`/appraisal/month/${empId}/form/${id}`);
    };
    ...
    return (
        <div>
            <div className="mb-3 flex justify-between">
                <p className='text-default font-extrabold text-xl'><FileTextOutlined className='mr-2' />{content['appraisalDay']}</p>
...
export default AppraisalMonthListPage
