...
import { createDayKpiApi } from '../../../services/KpiApi';
import { useNavigate } from 'react-router-dom';

const { Title } = Typography;

function KpiTemplateDayBuilder() {
    ...
    const handleSubmit = async (e) => {
        ...
        const response = await createDayKpiApi(payload);
        // message.success(content['saveSuccessFully']);
        setTitle('');
        setStartDate(null);
        setEndDate(null);
        setKpiItems([]);
        navigate(`/appraisal/kpi/day/update/${response?._id}`, {
            state: { successMessage: content['createSuccessFully'] },
        });
    };
...
export default KpiTemplateDayBuilder;
