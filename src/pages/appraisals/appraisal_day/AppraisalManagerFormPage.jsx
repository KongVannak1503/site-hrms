...
import { createAppraisalIndividualManagerDayApi, getAppraisalApi, getAppraisalIndividualManagerDayApi, updateAppraisalIndividualManagerDayApi } from '../../../services/AppraisalApi';
import { getKpiApi } from '../../../services/KpiApi';

const { Title } = Typography;

export default function AppraisalManagerFormPage() {
    ...
    const fetchTemplates = async () => {
        ...
        try {
            const resAppraisal = await getAppraisalApi(id);
            ...
            const resInd = await getAppraisalIndividualManagerDayApi(mainId, id, resAppraisal.kpiTemplate);
            if (resInd) {
    ...
    const handleSubmit = async () => {
        try {
            ...
            if (individual && individual._id) {
                // 🔁 Update if existing
                await updateAppraisalIndividualManagerDayApi(individual._id, payload);
                message.success(content['updateSuccessFully']);
            } else {
                // 🆕 Create new
                await createAppraisalIndividualManagerDayApi(payload);
