...
import { createAppraisalIndividualEmpDayApi, getAppraisalApi, getAppraisalIndividualEmpDayApi, updateAppraisalIndividualEmpDayApi } from '../../../services/AppraisalApi';
import { getKpiApi } from '../../../services/KpiApi';

const { Title } = Typography;

export default function AppraisalEmployeeFormPage() {
    ...
    const fetchTemplates = async () => {
        ...
        try {
            ...
            const resInd = await getAppraisalIndividualEmpDayApi(mainId, id, resAppraisal.kpiTemplate);
            if (resInd) {
    ...
    const handleSubmit = async () => {
        try {
            ...
            if (individual && individual._id) {
                // 🔁 Update if existing
                await updateAppraisalIndividualEmpDayApi(individual._id, payload);
                message.success(content['updateSuccessFully']);
            } else {
                // 🆕 Create new
                await createAppraisalIndividualEmpDayApi(payload);
