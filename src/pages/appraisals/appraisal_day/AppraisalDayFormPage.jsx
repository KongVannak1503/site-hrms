...
import { createKpiIndividualDayApi, getDayKpiApi, getKpiIndividualDayApi, updateKpiIndividualDayApi } from '../../../services/KpiApi';

const { Title } = Typography;

export default function AppraisalDayFormPage() {
    ...
    const fetchTemplates = async () => {
        ...
        try {
            ...
            const resInd = await getKpiIndividualDayApi(mainId, id);
            if (resInd) {
    ...
    const handleSubmit = async () => {
        try {
            ...
            if (individual && individual._id) {
                // 🔁 Update if existing
                await updateKpiIndividualDayApi(individual._id, payload);
                message.success(content['updateSuccessFully']);
            } else {
                // 🆕 Create new
                await createKpiIndividualDayApi(payload);
    ...
    const breadcrumbItems = [
        ...
        { breadcrumbName: content['kpiDay'], path: `/appraisal/day/${mainId}` },
