...
const AppraisalNav = () => {
    ...
    const tabs = [
        { key: 'profile', label: content['admin'] || 'Admin', path: `/appraisal/day/admin/${mainId}/form/${id}` },
        { key: 'position', label: content['manager'] || 'Manager', path: `/appraisal/day/manager/${mainId}/form/${id}` },
        { key: 'education', label: content['employees'], path: `/appraisal/day/employee/${mainId}/form/${id}` }
    ];
