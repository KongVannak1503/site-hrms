...
import { createAppraisalIndividualDayApi, getAppraisalApi, getAppraisalIndividualDayApi, updateAppraisalIndividualDayApi } from '../../../services/AppraisalApi';
import { getKpiApi } from '../../../services/KpiApi';

const { Title } = Typography;

export default function AppraisalAdminFormPage() {
    ...
    const fetchTemplates = async () => {
        ...
        try {
            ...
            const resInd = await getAppraisalIndividualDayApi(mainId, id, resAppraisal.kpiTemplate);
            if (resInd) {
    ...
    const handleSubmit = async () => {
        try {
            ...
            if (individual && individual._id) {
                // 🔁 Update if existing
                await updateAppraisalIndividualDayApi(individual._id, payload);
                message.success(content['updateSuccessFully']);
            } else {
                // 🆕 Create new
                await createAppraisalIndividualDayApi(payload);
