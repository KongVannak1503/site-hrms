...
import { createMonthKpiApi } from '../../../services/KpiApi';
...
function KpiTemplateMonthBuilder() {
    ...
    const handleSubmit = async (e) => {
        ...
        const response = await createMonthKpiApi(payload);
        setTitle('');
        setStartDate(null);
        setEndDate(null);
        setKpiItems([]);
        navigate(`/appraisal/kpi/month/update/${response?._id}`, {
...
export default KpiTemplateMonthBuilder;
