...
const KpiPage = () => {
    ...
    const handleDelete = async (id) => {
        try {
            await deleteKpiApi(id); // call the API
    ...
    const handleDuplicate = async (id) => {
        try {
            const response = await duplicateKpiApi(id); // call the API
            if (response?.data) {
    ...
    const handleAddCreated = () => {
        navigate('/appraisal/kpi/year/form');
    };
    const handleUpdate = (id) => {
        navigate(`/appraisal/kpi/year/update/${id}`);
    };
