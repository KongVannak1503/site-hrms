...
import { createKpiIndividualApi, getActiveKpiTemplatesApi, getKpiApi, getKpiIndividualThisYearApi, updateKpiIndividualApi } from '../../../services/KpiApi';
...
export default function AppraisalYearFormPage() {
    ...
    const fetchTemplates = async () => {
        ...
        try {
            ...
            const resInd = await getKpiIndividualThisYearApi(mainId, id);
            if (resInd) {
    ...
    const handleSubmit = async () => {
        try {
            ...
            if (individual && individual._id) {
                // 🔁 Update if existing
                await updateKpiIndividualApi(individual._id, payload);
