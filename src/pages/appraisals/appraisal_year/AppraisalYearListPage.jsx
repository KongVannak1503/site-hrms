...
import { deleteKpiApi, duplicateKpiApi, getAllKpiApi } from '../../../services/KpiApi';
...
const AppraisalYearListPage = () => {
    ...
    const handleUpdate = (empId, id) => {
        navigate(`/appraisal/year/${empId}/form/${id}`);
    };
    ...
    return (
        <div>
            <div className="mb-3 flex justify-between">
                <p className='text-default font-extrabold text-xl'><FileTextOutlined className='mr-2' />{content['appraisalYear']}</p>
...
export default AppraisalYearListPage
