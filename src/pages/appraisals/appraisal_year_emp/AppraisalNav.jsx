...
const AppraisalNav = () => {
    ...
    const tabs = [
        { key: 'profile', label: content['appraisalDay'], path: `/appraisal/employee/list/${mainId}` },
        { key: 'position', label: content['appraisalMonth'], path: `/appraisal/employee/month/${mainId}` },
        { key: 'education', label: content['appraisalYear'], path: `/appraisal/employee/year/${mainId}` }
    ];
