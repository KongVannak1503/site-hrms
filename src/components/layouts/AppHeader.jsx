...
const AppHeader = ({ collapsed, toggle }) => {
    ...
    const items = [
        ...
        },
        {
            label: (
                <ul class="flex flex-col gap-1 border-b border-gray-200 pb-3 pt-4 dark:border-gray-800">
                    <li>
                        <a href="profile.html" class="group flex items-center gap-3 rounded-lg px-3 py-2 text-theme-sm font-medium text-gray-700 hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300">
                    ...
                    <li>
                        <a href="chat.html" class="group flex items-center gap-3 rounded-lg px-3 py-2 text-theme-sm font-medium text-gray-700 hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300">
                            <svg class="fill-gray-500 group-hover:fill-gray-700 dark:fill-gray-400 dark:group-hover:fill-gray-300" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        {
            label: (
                <button class="cursor-pointer group mt-3 flex items-center gap-3 rounded-lg px-3 py-2 text-theme-sm font-medium text-gray-700 hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300">
            ...
            <div className='pt-1 flex items-center'>
                ...
                >
                    ...
                    <Select.Option value="khmer">
                        <img
                            src="https://p7.hiclipart.com/preview/496/188/891/angkor-wat-flag-of-cambodia-national-flag-khmer-flag.jpg"
                            alt="Khmer"
                ...
                {/* <Button
                    ...
                    type="text"
                    onClick={toggleTheme}
                    icon={currentTheme === 'light' ? <SunOutlined className='dark:text-white-500' /> : <MoonOutlined className='dark:text-white-500' />}
                /> */}
                ...
                >
                    <a onClick={(e) => e.preventDefault()}>
                        <Space>
                            ...
                            <span className="mr-1 block text-theme-sm font-medium text-gray-700 dark:text-gray-400">Mr. Vannak</span>
                        </Space>
                    </a>
                </Dropdown>
