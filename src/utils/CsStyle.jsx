export const Styles = {
    ...
    classDarkMode: '',
    classLightMode: '',
    tHead: 'bg-[#002060] text-left text-gray-200 font-semibold rounded-t-md',
    ...
    btnInfoSm: 'bg-[#0b9ab0] text-white rounded py-1 px-4 hover:bg-[#002060]',
    btnCreate: "px-4 py-2 cursor-pointer rounded text-white bg-[#002060] hover:bg-[#053084] transition duration-200 whitespace-nowrap",
    ...
    btnView: "flex items-center justify-center shadow hover:bg-[#002060] hover:text-white cursor-pointer rounded-full transition duration-200 w-[30px] h-[30px]",
    btnLgView: "px-4 py-2 cursor-pointer rounded text-white bg-blue-500 hover:bg-blue-400 transition duration-200",
    btnDownload: "btnDownload flex items-center justify-center shadow hover:bg-[#002060] hover:text-white cursor-pointer rounded-full transition duration-200 w-[30px] h-[30px]",
    btnHeaderIcon: "flex items-center justify-center shadow hover:bg-[#002060] bg-[#002060] text-white cursor-pointer rounded-full transition duration-200",
    ...
    btnSecondary: "border border-[#d9d9d9] text-[#595959] bg-white px-4 py-1.5 rounded hover:border-[#002060] hover:text-[#002060] transition-all duration-200 cursor-pointer",
    statusButtons: {
